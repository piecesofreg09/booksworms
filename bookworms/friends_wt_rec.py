...
file = open("win_sense_words.txt",'r')
json_file = open('dat_win.json')
data_file = json.load(json_file)

book_file = open('books_163929','r')
book_names = json.load(book_file)

user = str(sys.argv[1])
query_book = str(sys.argv[2])
...
for i in range(5):
	rec_dictionary = {}
	rec_dictionary["book"] = book_names[recommended_list[-i]]["name"]
	output_list.append(rec_dictionary)
